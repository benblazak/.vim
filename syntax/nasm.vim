...
syn keyword nasmType		BYTE WORD DWORD QWORD TWORD OWORD YWORD DQWORD HWORD DHWORD
syn keyword nasmType		CDECL FASTCALL NONE PASCAL STDCALL
syn keyword nasmStorage		DB DW DD DQ DT DO DY DDQ
syn keyword nasmStorage		RESB RESW RESD RESQ REST RESO RESY RESDQ
...
syn match   nasmGen64Register   "\<R\([A-D]X\|[DS]I\|[BS]P\)\>"
syn match   nasmGen64Register   "\<R\(8\|9\|1[0-5]\)[BDW]\=\>"
syn match   nasmSegRegister	"\<[C-GS]S\>"
syn match   nasmSpcRegister	"\<[ER]\=IP\>"
syn match   nasmFpuRegister	"\<ST\o\>"
syn match   nasmMmxRegister	"\<MM\o\>"
syn match   nasmSseRegister	"\<XMM\o\>"
syn match   nasm64SseRegister   "\<XMM\([8-9]\|1[0-5]\)\>"
...
" Streaming SIMD Extension 2 Packed Instructions: (requires SSE2 unit)
syn keyword nasmSse2Instruction	ADDPD ADDSD ANDNPD ANDPD CMPPD CMPSD
syn keyword nasmSse2Instruction COMISD CVTDQ2PD CVTDQ2PS CVTPD2DQ CVTPD2PI
syn keyword nasmSse2Instruction CVTPD2PS CVTPI2PD CVTPS2DQ CVTPS2PD CVTSD2SI
syn keyword nasmSse2Instruction CVTSD2SS CVTSI2SD CVTSS2SD CVTTPD2DQ
syn keyword nasmSse2Instruction CVTTPD2PI CVTTPS2DQ CVTTSD2SI DIVPD DIVSD
syn keyword nasmSse2Instruction MAXPD MAXSD MINPD MINSD MOVAPD MOVDQ2Q MOVDQA
syn keyword nasmSse2Instruction MOVDQU MOVHPD MOVLPD MOVMSKPD MOVQ2DQ MOVSD
syn keyword nasmSse2Instruction MOVUPD MULPD MULSD ORDP PADDQ PMULUDQ PSHUFHW
syn keyword nasmSse2Instruction PSHUFLW PSHUFD PSLLDQ PSRLDQ PSUBQ PUNPCKHQDQ
syn keyword nasmSse2Instruction PUNPCKLQDQ SHUFPD SQRTPD SQRTSD SUBPD SUBSD
syn keyword nasmSse2Instruction UCOMISD UNPCKHPD UNPCKLPD XORPD

" Streaming SIMD Extension 3 Packed Instructions: (requires SSE3 unit)
syn keyword nasmSse3Instruction ADDSUBPD ADDSUBPS HADDPD HADDPS HSUBPD HSUBPS
syn keyword nasmSse3Instruction MOVDDUP MOVSHDUP MOVSLDUP

" Supplemental Streaming SIMD Extension 3 Packed Instructions: (requires SSSE3 unit)
syn keyword nasmSsse3Instruction PSIGNW PSIGND PSIGNB PSHUFB PMULHRSW PMADDUBSW
syn keyword nasmSsse3Instruction PHSUBW PHSUBSW PHSUBD PHADDW PHADDSW PHADDD
syn keyword nasmSsse3Instruction PALIGNR PABSW PABSD PABSB

" Streaming SIMD Extension 4 Packed Instructions: (requires SSE4 unit)
syn keyword nasmSse4Instruction BLENDPD BLENDPS BLENDVPD BLENDVPS CRC32 DPPD
syn keyword nasmSse4Instruction DPPS EXTRACTPS EXTRQ INSERTPS INSERTQ LZCNT
syn keyword nasmSse4Instruction MOVNTDQA MOVNTSD MOVNTSS MPSADBW PACKUSDW
syn keyword nasmSse4Instruction PBLENDVB PBLENDW PCMPEQQ PCMPESTRI PCMPESTRM
syn keyword nasmSse4Instruction PCMPGTQ PCMPISTRI PCMPISTRM PEXTRB PEXTRD PEXTRQ
syn keyword nasmSse4Instruction PEXTRW PHMINPOSUW PINSRB PINSRD PINSRQ PMAXSB
syn keyword nasmSse4Instruction PMAXSD PMAXUD PMAXUW PMINSB PMINSD PMINUD PMINUW
syn keyword nasmSse4Instruction PMOVSXBD PMOVSXBQ PMOVSXBW PMOVSXDQ PMOVSXWD
syn keyword nasmSse4Instruction PMOVSXWQ PMOVZXBD PMOVZXBQ PMOVZXBW PMOVZXDQ
syn keyword nasmSse4Instruction PMOVZXWD PMOVZXWQ PMULDQ PMULLD POPCNT PTEST
syn keyword nasmSse4Instruction ROUNDPD ROUNDPS ROUNDSD ROUNDSS
...
if version >= 508 || !exists("did_nasm_syntax_inits")
  ...
  HiLink nasmSse2Instruction	Statement
  HiLink nasmSse3Instruction	Statement
  HiLink nasmSsse3Instruction	Statement
  HiLink nasmSse4Instruction	Statement
